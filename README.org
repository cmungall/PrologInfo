...
- [[https://github.com/sasagawa888/nprolog][N-Prolog]], "an interpreter and compiler to be superset of ARITY/PROLOG(MS-DOS)" (Kenichi Sasagawa: [[https://x.com/KSasagawa888][X]], [[https://medium.com/@kenichisasagawa][Medium]])
...
- [[https://github.com/samrose/datalox][Datalox]], A Datalog implementation in Elixir for building rule engines.
...
- [[https://github.com/google/mangle][Mangle]], an extension of Datalog, for deductive database programming, with various extensions like aggregation, function calls and optional type-checking, from Google.
...
- [[https://py-typedlogic.github.io/][PyTypedLogic]], a python package that wraps multiple logic engines, while specifying your logic programs in mypy-validated Python code.
